...
Widget categoryList(List<CategoryModel> categories,double padding, double ratio) {
  return BlocBuilder<CategoryCubit, CategoryState>(builder: (context, state) {
    ...
    return Container(
      ...
      child: GridView.builder(
        gridDelegate:  SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 4,childAspectRatio: ratio),
        shrinkWrap: true,
       ...
       return  InkWell(
          onTap: (){},
           child: Column(
            ...
            children: [
              Image.network("${API().baseUrl}/images/${category.icon}", height: 50,),
