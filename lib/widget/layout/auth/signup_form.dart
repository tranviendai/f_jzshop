...
class _SignUpFormState extends State<SignUpForm> {
  ...
  void signUp() async {
    if(username.text == "" || password.text == "" || fullname.text == ""){
      showError(context, "Please!, Input username or password or fullname");
    }else{
      APIRepository().register(context, username.text, password.text,fullname.text);
        ...
        child: Container(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                AppText.textFiled(context, fullname, "FullName", Icons.mode_rounded),
                ...
                AppButton().btnSubmit(context, "Sign Up", signUp),
